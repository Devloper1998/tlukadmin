...
if ($sel_data) {
    ...
    $filePath = 'https://spondiastech.com/tlukadmin/adminEmail.html'; 
    $content = file_get_contents($filePath);

    // Replace placeholders with actual values
    $content = str_replace(['{{name}}', '{{message}}'], [$username, $message], $content);

    // Load User Email Template
    // $userTemplatePath = 'https://spondiastech.com/tlukadmin/userEmail.html'; 
