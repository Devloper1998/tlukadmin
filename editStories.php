                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control"
                                                        value="<?php echo $res_data[0]['title']?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Story Main Image</label><br>
                                                    <img src="<?php echo $main_image?>" width="100" height="auto"
                          ...
                          <input type="time" name="end_time" id="end_time" class="form-control" value="<?php //echo $res_data[0]['end_time'] ?>" readonly>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <img src="<?php echo $profile_image?>" width="100" height="auto"
                                                        style="border-radius: 10px;">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="name" class="form-control"
                                                        value="<?php echo $res_data[0]['name']?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description1" name="description1" class="form-control"
                                                        readonly><?php echo $res_data[0]['description1']?></textarea>
                                                </div>
                                            </div>
                                            <!-- <div class="col-12">
                                                <div class="form-group">
                                                    <label>Story Image1</label><br>
                                                    <img src="<?php //echo $story_image1;?>" width="100" height="auto"
                                                        style="border-radius: 10px;">&ensp;
                                            ...
                                            <!-- <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description2" name="description2" class="form-control"
                                                        readonly><?php //echo $res_data[0]['description2']?></textarea>
                                                </div>
                                            </div> -->
                                            <!-- <div class="col-12">
                                                <div class="form-group">
                                                    <label>Story Image2</label><br>
                                                    <img src="<?php //echo $story_image2;?>" width="100" height="auto"
                                                        style="border-radius: 10px;">&ensp;
                        ...
                        <p> <span style="color:red;font-weight: bold;">Note:</span>Upload Multiple Images </p>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control"
                                                        value="<?php echo $res_data[0]['title'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="oldmain_image" id="oldmain_image"
                                                        class="form-control"
                                                        value="<?php echo $res_data[0]['main_image'] ?>">
                          ...
                          <input type="time" name="end_time" id="end_time" class="form-control" value="<?php //echo $res_data[0]['end_time'] ?>" >
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="profile_image" id="profile_image"
                                                        ...
                                                        accept="image\*">
                                                    <input type="hidden" name="oldprofile_image" id="oldprofile_image"
                                                        class="form-control"
                                                        value="<?php echo $res_data[0]['profile_image'] ?>">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="name" class="form-control"
                                                        value="<?php echo $res_data[0]['name'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description1" name="description1"
                                                        class="form-control"><?php echo $res_data[0]['description1'] ?></textarea>
                                                </div>
                                            </div>
                                            <!-- <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="story_image1" id="story_image1"
                                                        ...
                                                        accept="image\*">
                                                    <input type="hidden" name="oldstory_image1" id="oldstory_image1"
                                                        class="form-control"
                                                        value="<?php //echo $res_data[0]['story_image1'] ?>">
                                                    <p><span style="color:red;">Note:</span> &nbsp;Please upload an
                                                        ...
                                                        <img id="previewImage2"
                                                            ...
                                                            width="150" height="auto">
                                                        <img src="<?php //echo $story_image1;?>" width="100"
                                                            style="border-radius: 10px; margin-top: 10px;">
                                            ...
                                            <!-- <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description2" name="description2"
                                                        class="form-control"><?php //echo $res_data[0]['description2'] ?></textarea>
                                                </div>
                                            </div> -->
                                            <!-- <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="story_image2" id="story_image2"
                                                        ...
                                                        accept="image\*">
                                                    <input type="hidden" name="oldstory_image2" id="oldstory_image2"
                                                        class="form-control"
                                                        value="<?php //echo $res_data[0]['story_image2'] ?>">
                                                    <p><span style="color:red;">Note:</span> &nbsp;Please upload an
                                                        image with dimensions <strong>1600px × 1200px</strong><br>
                                                        <img id="previewImage3"
                                                            style="display:none;border-radius: 10px; margin-top: 10px; margin-top: 10px;"
                                                            width="150" height="auto">
                                                        <img src="<?php //echo $story_image2 ;?>" width="100"
                                                            style="border-radius: 10px; margin-top: 10px;">
                        ...
                        <p> <span style="color:red;font-weight: bold;">Note:</span>Upload Multiple Images </p>
                                            ...
                                            <div class="col-6">
                                                <input type="hidden" name="hdn_id" id="hdn_id"
                                                    value="<?php echo $res_data[0]['randomId']; ?>">
