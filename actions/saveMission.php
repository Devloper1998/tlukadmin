...
$image = '';
$image_targetDir = "../uploads/mission/";
$finalImagePath = '';
...
if(isset($_POST["action"]) && $_POST['action'] == 'Display'){
    ...
    $sql_show = "SELECT * FROM tluk_mission order by id desc ";
...
if(isset($_POST["action"]) && $_POST['action'] == 'delete'){
    ...
    $delmission = "DELETE FROM ".$tableName." where id = '".$_POST['id']."'";
    $deldata = $crud->execute($delmission);
