...
// $image = '';
// $image_targetDir = "../uploads/community/";
...
if(isset($_POST["action"]) && $_POST['action'] == 'Display'){
    ...
    $sql_show = "SELECT * FROM tluk_community order by id desc";
...
if(isset($_POST["action"]) && $_POST['action'] == 'delete'){
    ...
    $delcommunity = "DELETE FROM ".$tableName." where id = '".$_POST['id']."'";
    $deldata = $crud->execute($delcommunity);
