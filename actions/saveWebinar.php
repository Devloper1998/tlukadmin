...
if(isset($_POST["action"]) && $_POST['action'] == 'save'){
	 ...
	 $insQry = "INSERT INTO ".$tableName." SET webinar_name = '".$webinar_name."', date ='".$date."',start_time ='".$start_time."',end_time ='".$end_time."',description1 ='".$description1."',description2 ='".$description2."',main_image ='".$main_image."',image ='".$image."',webinar_location ='".$webinar_location."',randomId = '".$randomId."'";
...
if(isset($_POST["action"]) && $_POST['action'] == 'update'){
     ...
     $upQry = "UPDATE ".$tableName." SET webinar_name = '".$webinar_name."',date ='".$date."',start_time ='".$start_time."',end_time ='".$end_time."',description1 ='".$description1."',description2 ='".$description2."',main_image ='".$main_image."',image ='".$image."',webinar_location ='".$webinar_location."' where randomId = '".$hdn_id."'";
