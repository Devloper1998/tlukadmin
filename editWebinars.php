                  ...
                  <form name="editform" id="editform" method="post" enctype="multipart/form-data">
                    <div class="row">
                      <?php if ($_GET['type']=='view') { ?>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="webinar_name" id="webinar_name" class="form-control" value="<?php echo $webinardata[0]['webinar_name'];?>" readonly>
                       ...
                       <div class="col-4">
                        <div class="form-group">
                          <label>Date</label>
                          <input type="date" name="date" id="date" class="form-control" value="<?php echo $webinardata[0]['date'];?>" readonly>
                      ...
                      <div class="col-4">
                        <div class="form-group">
                          ...
                          <input type="time" name="start_time" id="start_time" class="form-control" value="<?php echo $webinardata[0]['start_time'];?>" readonly>
                       ...
                       <div class="col-4">
                        <div class="form-group">
                          ...
                          <input type="time" name="end_time" id="end_time" class="form-control" value="<?php echo $webinardata[0]['end_time'];?>" readonly>
                       ...
                       <div class="col-12">
                        <div class="form-group">
                          ...
                          <textarea id="description1" name="description1" class="form-control" readonly><?php echo $webinardata[0]['description1'];?></textarea>
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <textarea id="description2" name="description2" class="form-control" readonly><?php echo $webinardata[0]['description2'];?></textarea>
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <textarea id="webinar_location" name="webinar_location" class="form-control" readonly><?php echo $webinardata[0]['webinar_location'];?></textarea>
                        </div>
                      </div>
                    ...
                    <?php if ($_GET['type']=='edit') { ?>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="webinar_name" id="webinar_name" class="form-control"  value="<?php echo $webinardata[0]['webinar_name'];?>">
                       ...
                       <div class="col-4">
                        <div class="form-group">
                          ...
                          <input type="date" name="date" id="date" class="form-control"  value="<?php echo $webinardata[0]['date'];?>">
                      ...
                      <div class="col-4">
                        <div class="form-group">
                          ...
                          <input type="time" name="start_time" id="start_time" class="form-control"  value="<?php echo $webinardata[0]['start_time'];?>">
                       ...
                       <div class="col-4">
                        <div class="form-group">
                          ...
                          <input type="time" name="end_time" id="end_time" class="form-control"  value="<?php echo $webinardata[0]['end_time'];?>">
                       ...
                       <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="oldmain_image" id="oldmain_image" class="form-control"  value="<?php echo $webinardata[0]['main_image'];?>">
                       ...
                       <div class="col-12">
                        <div class="form-group">
                          ...
                          <textarea id="description1" name="description1" class="form-control"><?php echo $webinardata[0]['description1'];?></textarea>
                       ...
                       <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="oldimage" id="oldimage" class="form-control"  value="<?php echo $webinardata[0]['image'];?>">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <textarea id="description2" name="description2" class="form-control"><?php echo $webinardata[0]['description2'];?></textarea>
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <textarea id="webinar_location" name="webinar_location" class="form-control"><?php echo $webinardata[0]['webinar_location'];?></textarea>
                        </div>
                      </div>
                     
                    <?php } ?>
                      <div class="col-6">
                      <button type="button" class="btn btn-danger" onclick="location.href = 'manageWebinars.php'">Cancel</button>
                      </div>
                      <?php if ($_GET['type'] == 'edit') { ?>
                      <div class="col-6">
                        <input type="hidden" name="hdn_id" id="hdn_id" value="<?php echo $webinardata[0]['randomId']; ?>">
