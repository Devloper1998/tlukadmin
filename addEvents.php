                    ...
                    <div class="col-12">
                      ...
                      <div class="col-4">
                       ...
                       <div class="col-12">
                        <div class="form-group">
                          ...
                          <img id="previewImage1" src="#" alt="New Image Preview" style="display:none;border-radius: 10px;" width="150" height="auto">
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <textarea id="event_location" name="event_location" class="form-control"></textarea>
                        </div>
                      </div>
