...
<?php include('includes/header.php'); 
   ...
   $home_image= str_replace('../', '', $eventdata[0]['home_image']);
                                ...
                                <div class="card-body">
                                    ...
                                    <form name="editform" id="editform" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="event_name" id="event_name"
                                                        class="form-control"
                                                        value="<?php echo $eventdata[0]['event_name'];?>" readonly>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="start_time" id="start_time"
                                                        class="form-control"
                                                        value="<?php echo $eventdata[0]['start_time'];?>" readonly>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="end_time" id="end_time"
                                                        class="form-control"
                                                        value="<?php echo $eventdata[0]['end_time'];?>" readonly>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Event Detail Image</label><br>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description1" name="description1" class="form-control"
                                                        readonly><?php echo $eventdata[0]['description1'];?></textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description2" name="description2" class="form-control"
                                                        readonly><?php echo $eventdata[0]['description2'];?></textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="event_location" name="event_location"
                                                        class="form-control"
                                                        readonly><?php echo $eventdata[0]['event_location'];?></textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="event_name" id="event_name"
                                                        class="form-control"
                                                        value="<?php echo $eventdata[0]['event_name'];?>">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input type="date" name="date" id="date" class="form-control"
                                                        value="<?php echo $eventdata[0]['date'];?>">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="start_time" id="start_time"
                                                        class="form-control"
                                                        value="<?php echo $eventdata[0]['start_time'];?>">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="end_time" id="end_time"
                                                        class="form-control"
                                                        value="<?php echo $eventdata[0]['end_time'];?>">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="oldmain_image" id="oldmain_image"
                                                        class="form-control"
                                                        value="<?php echo $eventdata[0]['main_image'];?>">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Event Detail Image</label>
                                                    ...
                                                    <input type="hidden" name="oldhome_image" id="oldhome_image"
                                                        class="form-control"
                                                        value="<?php echo $eventdata[0]['home_image'];?>">
                                                    <p><span style="color:red;">Note:</span> &nbsp;Please upload an
                                                        image with dimensions <strong>800px × 600px</strong><br>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description1" name="description1"
                                                        class="form-control"><?php echo $eventdata[0]['description1'];?></textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description2" name="description2"
                                                        class="form-control"><?php echo $eventdata[0]['description2'];?></textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Event Location</label>
                                                    <textarea id="event_location" name="event_location"
                                                        class="form-control"><?php echo $eventdata[0]['event_location'];?></textarea>
                                            ...
                                            <div class="col-6">
                                                <input type="hidden" name="hdn_id" id="hdn_id"
                                                    value="<?php echo $eventdata[0]['randomId']; ?>">
