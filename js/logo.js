function loadData() {
  ...
  if (input.files && input.files[0]) {
    ...
    $('#footer_logo').on('change', function(event) {
  ...
  "columns": [
    ...
    { "data": "id",
      "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                bnTd = `<a href="editLogo.php?type=view&randomId=${oData.randomId}" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;&nbsp;
                <a href="editLogo.php?type=edit&randomId=${oData.randomId}" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;
...
$(function() {
  ...
  $("form[name='addformpage']").validate({
    ...
    messages: {         
      ...
      header_logo          : "Please Upload the Header Logo",
    ...
    submitHandler: function(form) {
        ...
        if (header_logo.length > 0){
         ...
         let footer_logo = $('#footer_logo')[0].files;
