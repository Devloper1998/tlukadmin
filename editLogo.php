...
<?php include('includes/header.php'); 
  ...
  $logoqry = "select * from tluk_logo  WHERE randomId = '".$randomId."'";
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form name="editform" id="editform" method="post" enctype="multipart/form-data">
                    ...
                    <?php if ($_GET['type']=='edit') { ?>
                       ...
                       <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="oldheader_logo" id="oldheader_logo" class="form-control"  value="<?php echo $logodata[0]['header_logo'];?>">
                       ...
                       <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="oldfooter_logo" id="oldfooter_logo" class="form-control"  value="<?php echo $logodata[0]['footer_logo'];?>">
                          <input type="file" name="footer_logo" id="footer_logo" class="form-control">
                          <img id="previewImage1" src="#" alt="New Image Preview" style="display:none;" width="150" height="auto">
                          <img src="<?php echo $footerlogo; ?>" width="100" style="border-radius: 10px;margin-top: 10px;">
                    ...
                    <?php } ?>
                      <div class="col-6">
                      <button type="button" class="btn btn-danger" onclick="location.href = 'manageLogo.php'">Cancel</button>
                      </div>
                      <?php if ($_GET['type'] == 'edit') { ?>
                      <div class="col-6">
