                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="description" id="description"
                                                        cols="5"
                                                        rows="5"><?php echo $aboutdata[0]['description']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>About Description1 <span class="star">*</span></label>
                                                    <textarea class="form-control" name="description1" id="description1"
                                                        cols="5"
                                                        rows="5"><?php echo $aboutdata[0]['description1']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-6">
                                                <button type="button" class="btn btn-danger"
                                                    onclick="location.href = 'manageAbout.php'">Cancel</button>
                                            </div>
                                            <div class="col-6">
