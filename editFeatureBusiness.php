...
<?php include('includes/header.php'); 
  ...
  $businessqry = "select tf.*,tf.randomId as rand ,tc.* from tluk_featurebussines as tf left join tluk_categories as tc on tc.id = tf.catg_id WHERE tf.randomId = '".$randomId."'";
   ...
   $home_image = str_replace('../', '', $businessdata[0]['home_image']);
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="catg_id" class="form-control" id="catg_id"
                                                        value="<?php echo $businessdata[0]['category_name'] ?>"
                                                        readonly>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control"
                                                        value="<?php echo  $businessdata[0]['title']?>" readonly>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Business Detail Image</label>
                                                    <br>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description" name="description" class="form-control"
                                                        readonly><?php echo  $businessdata[0]['description']?></textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="discount" id="discount"
                                                        ...
                                                        value="<?php echo  $businessdata[0]['discount']?>">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="address" name="address" class="form-control"
                                                        readonly><?php echo  $businessdata[0]['address']?></textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="business_url" id="business_url"
                                                        class="form-control" readonly
                                                        value="<?php echo  $businessdata[0]['business_url']?>">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="accounts" id="accounts"
                                                        class="form-control" readonly
                                                        value="<?php echo  $businessdata[0]['accounts']?>">
                                            ...
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="account_link" id="account_link"
                                                        class="form-control" readonly
                                                        value="<?php echo  $businessdata[0]['account_link']?>">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <img src="<?php echo $business_logo; ?>" width="100"
                                                        style="border-radius: 10px; margin-top: 10px;">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Business Title</label>
                                                    <input type="text" name="title" id="title" class="form-control"
                                                        value="<?php echo  $businessdata[0]['title']?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p><span style="color:red;">Note:</span> &nbsp;Please upload an
                                                        ...
                                                        <input type="hidden" name="oldmain_image" id="oldmain_image"
                                                            class="form-control"
                                                            value="<?php echo  $businessdata[0]['main_image']?>?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p><br>
                                                        ...
                                                        <input type="hidden" name="oldhome_image" id="oldhome_image"
                                                            class="form-control"
                                                            value="<?php echo  $businessdata[0]['home_image']?>?>">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description" name="description"
                                                        class="form-control"><?php echo  $businessdata[0]['description']?></textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="address" name="address"
                                                        class="form-control"><?php echo  $businessdata[0]['address']?></textarea>
                                            ...
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label>Business Social Account Link </label>
                                                    <input type="url" name="account_link" id="account_link"
                                                        class="form-control"
                                                        value="<?php echo  $businessdata[0]['account_link']?>">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <img id="previewImage1"
                                                        style="display:none;border-radius: 10px; margin-top: 10px;"
                                                        width="150" height="auto">
                                                    <input type="hidden" name="oldbusiness_logo" id="oldbusiness_logo"
                                                        class="form-control"
                                                        value="<?php echo  $businessdata[0]['business_logo'];?>">
                                                    <img src="<?php echo  $business_logo;?>" width="100"
                                                        style="border-radius: 10px;margin-top: 10px;">
                                            ...
                                            <div class="col-6">
                                                <button type="button" class="btn btn-danger"
                                                    onclick="location.href = 'manageFeatureBusiness.php'">Cancel</button>
                                            </div>
                                            <?php if ($_GET['type'] == 'edit') { ?>
                                            <div class="col-6">
                                                <input type="hidden" name="hdn_id" id="hdn_id"
                                                    value="<?php echo $businessdata[0]['rand']; ?>">
