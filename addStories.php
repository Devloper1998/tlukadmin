                     ...
                     <!--  <div class="col-12">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <img id="previewImage2" style="display:none;border-radius: 10px; margin-top: 10px;" width="150" height="auto">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="file" name="story_image2" id="story_image2" class="form-control image-upload" data-preview="#previewImage3" accept="image\*">
                           <p><span style="color:red;">Note:</span> &nbsp;Please upload an image with dimensions <strong>1600px × 1200px</strong><br>
                          <img id="previewImage3" style="display:none;border-radius: 10px; margin-top: 10px;" width="150" height="auto">
