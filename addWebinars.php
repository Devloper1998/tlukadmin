          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Add Webinar</h4>
                  ...
                  <form name="addformpage" id="addformpage" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="webinar_name" id="webinar_name" class="form-control">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <textarea id="description2" name="description2" class="form-control"></textarea>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                          <label>Webinar Location <span class="star">*</span></label>
                          <textarea id="webinar_location" name="webinar_location" class="form-control"></textarea>
                        </div>
                      </div>
