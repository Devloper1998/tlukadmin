...
<style type="text/css">
   .bg-logins {
    background: url('assets/logoicon.png');
                ...
                <div class="col-12">
                    <div class="d-flex align-items-center min-vh-100">
                        <div class="w-100 d-block bg-white shadow-lg rounded my-5">
                            <div class="row">
                                <div class="col-lg-5 d-none d-lg-block bg-logins rounded-left"></div>
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        ...
                                        <p class="text-muted mb-4 text-center">Enter your email address and password to access admin panel.</p>
                                            <div class="form-group">
                                                <input type="email" class="form-control form-control-user" id="username" placeholder="Email Address">
                                            </div>
                                            <div class="form-group">
                                                <input type="password" class="form-control form-control-user" id="password" placeholder="Password">
                                            </div>
                                            <a href="#" class="btn btn-primary btn-block waves-effect waves-light" onclick="loginval()"> Log In </a>
